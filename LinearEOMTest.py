...
vehicle_pos = pygame.Vector2()
vehicle_pos.xy = dnrng0,alt0

vehicle_vel = pygame.Vector2()
vehicle_vel.xy = velx0,vely0
...
while not done:
    ...
    ## EOM UPDATES
    vehicle_vel = vehicle_vel + (aero_accel(vehicle_pos,vehicle_vel) + gravity_accel(vehicle_pos))*dt
